...
public class MidiaVistoria {
	...
	public void confirmarArquivo() {
		 String mensagem = "Deseja confirmar o envio deste arquivo?\n\n"
                 + "Digite 'ok' para confirmar ou 'cancelar' para cancelar:";
String resposta = JOptionPane.showInputDialog(mensagem);

	if (resposta != null && resposta.equalsIgnoreCase("ok")) {
		JOptionPane.showMessageDialog(null, "Arquivo confirmado com sucesso!");
	} else {
		JOptionPane.showMessageDialog(null, "Envio de arquivo cancelado.");
	}
}
